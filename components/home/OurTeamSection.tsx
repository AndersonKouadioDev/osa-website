    ...
    <div className="bg-gray-100 py-12 px-4 md:px-8 relative overflow-hidden bg-center">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="flex justify-center mt-6">
          <button className="flex items-center px-6 py-3 bg-white text-primary rounded-full font-semibold hover:bg-gray-100 transition-colors shadow-lg cursor-pointer"  onClick={()=>router.push('/effectif') } >
