...
const Banner = () => {
  return (
    <div className='px-7 mt-5'>
      ...
      <div className="relative py-16 md:py-20 flex items-center bg-center bg-cover bg-[#062c31] justify-center" 
      style={{ backgroundImage: "url('/Assets/images/all-img/BackgroundEquipe.png')" }}  >
        ...
        <div className="relative text-center">
          ...
          <div className="mt-8 flex justify-center">
            <a href="#" className="bg-yellow-400 text-black font-bold py-2 px-5 rounded-full shadow-lg hover:bg-yellow-500 transition-colors duration-300 flex items-center space-x-2 text-sm">
